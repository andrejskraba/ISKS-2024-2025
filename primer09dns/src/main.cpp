...
DNSServer dnsServer; // instanca DNS strežnika
...
const char HTML0[] PROGMEM = R"rawliteral(
  ...
  <body>
      ...
      <a class="gumb" id="LED-prizgi" href="/1">Prižgi LED</a>
      <a class="gumb" id="LED-ugasni" href="/0">Ugasni LED</a>
...
void setup() {
  ...
  dnsServer.start(53, "*", WiFi.softAPIP()); // DNS strežnik posluša na vratih 53 | * odgovorimo na vsako zahtevo
